    ...
    <div className="bg-[#111] text-center w-full h-screen flex justify-center align-middle           
      ...
      {loader ? (
        ...
        <div
          ...
          style={{
            position: "fixed",
            backgroundImage: `linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url(${home_img})`,
