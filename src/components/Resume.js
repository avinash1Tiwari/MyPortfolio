...
import express from "../assets/skills/ex1.png";
import nodejs from "../assets/skills/nodeJs.png";
import cplus from "../assets/skills/c++_logo.png";
    ...
    >
      ...
      <div className="flex flex-col align-middle justify-center">
        <div className="m-auto p-20">
          <p className="text-thin text-[#9f9f9f] text-center">
            Check out My Resume
          </p>
        ...
        <div className="flex align-middle justify-center max-md:flex-col m-auto">
          ...
          <div className=" lg:pr-20">
            ...
            <div className="card w-[500px] max-lg:w-[335px] box-border  bg-[#161616] relative lg:pt-8 lg:pl-12 lg:pb-8 lg:pr-12 max-lg:pt-4 max-lg:pl-8 max-lg:pb-4 max-lg:pr-8  border-b border-l-[#009e66] border-l-2">
              ...
              <h1 className=" inline text-xl">
                KIET Group of Institution (AKTU)
              </h1>
              <p className="text-[rgb(159,159,159)] text-base pb-2 pt-2 ">
                Ghaziabad <span className="text-[13px]">(Nov'21 - Jun'25)</span>
              </p>
              <p className="text-[#9f9f9f] text-[13px] pb-2">
                Bachelors degree in Computer Science and Information Technology(
                GPA : 8.5 )
              </p>
            </div>
            <div className="max-lg:w-[335px] w-[500px] bg-[#161616] relative border-b lg:pt-8 lg:pl-12 lg:pb-8 lg:pr-12 max-lg:pt-4 max-lg:pl-8 max-lg:pb-4 max-lg:pr-8 border-l-[#009e66] border-l-2">
              <span className="before:absolute before:left-0 before:mt-1 before:h-4 before:w-4 before:bg-[#009e66]"></span>
              <h1 className="inline text-xl">
                M.T.S Public School and College
              </h1>
              <p className="text-[#9f9f9f] text-base pb-2 pt-2">
                Mirzapur <span className="text-[13px]">(Apr'19 - May-'20)</span>
              </p>
              <p className="text-[#9f9f9f] text-[13px]">
                Intermediate ( CBSE ), Science ( Score: 86.6% ){" "}
              </p>
            </div>
            <div className="max-lg:w-[335px] w-[500px]  bg-[#161616] relative lg:pt-8 lg:pl-12 lg:pb-8 lg:pr-12 max-lg:pt-4 max-lg:pl-8 max-lg:pb-4 max-lg:pr-8 border-l-[#009e66] border-l-2">
              ...
              <p className="text-[#9f9f9f] text-base pb-2 pt-2">
                Mirzapur <span className="text-[13px]">(May'17 - Apr'18)</span>
              </p>
              <p className="text-[#9f9f9f] text-[13px]">
                High School ( CBSE ) ( Score: 84.4%)
              </p>
            </div>
          </div>
          {/* Experience */}
          <div className="max-sm:mt-4 pl-20 max-lg:pl-5 max-sm:pl-0">
            ...
            <div className="max-lg:w-[335px] w-[500px] relative bg-[#161616] border-b lg:pt-8 lg:pl-12 lg:pb-8 lg:pr-12 max-lg:pt-4 max-lg:pl-8 max-lg:pb-4 max-lg:pr-8 border-l-[#009e66] border-l-2">
              <span className="before:absolute before:left-0 before:mt-1 before:h-4 before:w-4 before:bg-[#009e66] "></span>
              <h1 className="inline text-xl">
                Product Engineer Trainee Intern at Rapipay
              </h1>
              <p className="text-[#9f9f9f] text-base pb-2 pt-2">
                Noida (Aug'24 - Present)
              </p>
              <ul className="list-disc text-[#9f9f9f] text-[12px]">
                <li>
                  <p>
                    Rapipay is a versatile digital payment platform offering
                    seamless bill payments, money transfers, and mobile
                    recharges via its mobile and web apps, designed to simplify
                    financial transactions for users and businesses.{" "}
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    My role includes developing and maintaining backend systems
                    for digital verification processes,Integrating with
                    Digilocker and Finbit to fetch and process KYC data
                    efficiently and Optimizing verification workflows to enhance
            ...
            <div className="max-lg:w-[335px] w-[500px] relative bg-[#161616] border-b lg:pt-8 lg:pl-12 lg:pb-8 lg:pr-12 max-lg:pt-4 max-lg:pl-8 max-lg:pb-4 max-lg:pr-8 border-l-[#009e66] border-l-2">
              ...
              <p className="text-[#9f9f9f] text-base pb-2 pt-2">
                Ghaziabad (May'24 - July'24)
              </p>
              <ul className="list-disc text-[#9f9f9f] text-[12px]">
                <li>
                  <p>
                    Protut is an edtech startup dedicated to designing a
                    platform that enhances technical projects and improves
                    candidate evaluations.{" "}
                  </p>
                </li>
                <li>
                  <p>
                    Developing the frontend as well as backend of Protut’s
                    edtech platform using React.js,NodeJs,MongoDb and ExpressJs,
                    enhancing user experience, and optimizing functionality
                  </p>
                </li>
              </ul>
            </div>
            <div className="max-lg:w-[335px] w-[500px] relative bg-[#161616] lg:pt-8 lg:pl-12 lg:pb-8 lg:pr-12 max-lg:pt-4 max-lg:pl-8 max-lg:pb-4 max-lg:pr-8 border-l-[#009e66] border-l-2">
              ...
              <ul className="list-disc text-[#9f9f9f] text-[12px]">
                <li>
                  <p>
                    Acquired knowledge in Cyber Security fundamentals during
                    Internship
                  </p>
                </li>
                <li>
                  <p>
                    Executed a project to evaluate the existing college network
                    and Designed campus network blueprint using Cisco Packet
                    Tracer.
                  </p>
                </li>
              </ul>
        ...
        <div className="text-left mb-4">
          ...
          <div className="text-[#c9c8c8] w-10/12 grid grid-cols-2 sm:grid-cols-4 gap-7 text-center lg:p-16 m-auto mt-8">
            ...
            <div className=" rounded-md shadow-md shadow-[#009e66] hover:scale-105 duration-300  flex justify-center align-middle">
              <img src={nodejs} alt="html" className="my-4 w-6 h-6" />
              <p className="my-4 mx-2">NodeJs</p>
            </div>
            <div className=" rounded-md shadow-md shadow-[#009e66] hover:scale-105 duration-300  flex justify-center align-middle">
              <img src={express} alt="html" className="my-4 mr-1 w-9 h-6" />
            ...
            <div className=" rounded-md shadow-md shadow-[#009e66] hover:scale-105 duration-300  flex justify-center align-middle">
              <img src={cplus} alt="html" className="my-4 w-6 h-6" />
              <p className="my-4 mx-2">C++</p>
            </div>
            <div className=" rounded-md shadow-md shadow-[#009e66] hover:scale-105 duration-300  flex justify-center align-middle">
