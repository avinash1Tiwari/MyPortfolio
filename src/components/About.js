...
import about_img from "../assets/avinash.jpg";
          ...
          <div className="ml-14 max-md:ml-0">
            <div className="p-5 ">
              ...
              <h1 className="text-3xl font-bold p-3 max-md:text-xl">
                I'm Avinash Tiwari, Full Stack Developer and C++ Programmer
              </h1>
              <p className="text-[#9f9f9f] p-2 text-sm">
                I am an undergraduate student pursuing a B.Tech in Computer
                Science at KIET Group of Institutions. I have a passion for
                developing solutions and am a keen learner. I enjoy working in
                C++ and collaborating with Technical Societies. As a web
                developer, I love creating human-centric websites using ReactJs
                and NextJs, and infusing functionality using NodeJs. My goal is
                to create value and impact to bring about positive change.
              </p>
            ...
            <div className="flex flex-col max-md:ml-5">
              <div className="flex max-md:flex-col max-md:p-0 p-2 ">
                <div className="flex pl-4 max-md:pl-0">
                  <span>Name:</span>
                  <p className="pl-2 text-[#9f9f9f]">Avinash Tiwari</p>
                </div>
                <div className="flex pl-40 max-md:pl-0">
                  <span>Email:</span>
                  <p className="pl-2 text-[#009e66] hover:text-[#346b57] cursor-pointer">
                    <a href="mailto:avinashtiwari2405@gmail.com">
                    avinashtiwari2405@gmail.com
                    </a>
                  </p>
                </div>
              </div>
              <div className="flex max-md:flex-col  max-md:p-0 p-2">
                ...
                <div className="flex pl-[283px] max-md:pl-0">
                  <span>Live: </span>
                  <p className="pl-2 text-[#9f9f9f]">Mirzapur, Uttar Pradesh</p>
                </div>
              </div>
            </div>
            <div>
              <button class="mt-2 ml-5 bg-[#009e66] hover:bg-[#0e522b] text-white font-bold py-2 px-4 rounded-full mb-3">
                <Link
                  to="https://drive.google.com/drive/folders/19KhvQtd5g5gZO7OPiAsh-qP0AmjhSFE1"
                  target="_blank"
                >
                  <DownloadIcon
                    sx={{ fontSize: "20px" }}
                    className="animate-bounce mr-1 text-sm"
                  />{" "}
                  Resume
                </Link>
              </button>
